...
plot(t1,R1,type='l',ylim=c(0,4),ylab='有效再生数',xlab='日期',xaxt="n")
axis(1,c(seq(0,150,30)),c("2020-01-10","2020-02-10","2020-03-10","2020-04-10","2020-05-10","2020-06-10"))

abline(h=1,v=log(R0)/k+34,lty=2)
text(T1+40,2,"2020-02-06")
title('全国除湖北以外地区')
