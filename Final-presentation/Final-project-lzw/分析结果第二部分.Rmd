...
|参数|$\beta$|$k$|$\sigma$|$\gamma$|
:-:|:-:|:-:|:-:|:-:
|估计值|$0.644$|$0.108$|$0.162$|$0.160$|
...
通过上述重要参数的估计及分析计算累计人数的拟合值，并作图与真实观测值进行对比拟合。如下图，可以看出全国除湖北以外地区疫情的真实观测值与拟合值的发展趋势基本一致，拟合曲线基本吻合，这表明SEIR模型对新冠疫情的传播机制和传播速度能够给出有效的解释和说明。
